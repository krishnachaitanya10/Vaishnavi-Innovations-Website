...
var De = class _De {
  constructor(t, a = {}) {
    ...
    Object.assign(this, _De.Defaults, a, { eventType: t }), this._preventDefault = function() {
...
var ei = defineComponent({
  ...
  setup(e, { emit: t }) {
    ...
    return (F, I) => (openBlock(), createElementBlock("div", mergeProps(unref(h2), {
      ...
      (openBlock(true), createElementBlock(Fragment, null, renderList(unref(B), (V, _) => (openBlock(), createBlock(fn2, mergeProps({
        key: _,
        modelValue: unref(w),
